...
CREATE TABLE articulo(
    ...
    cantidad NUMBER(5) CONSTRAINT cant_art_nt NOT NULL,
...
INSERT INTO empleado VALUES('E-0'||TO_CHAR(empleados.nextval),'DE-03','Juána','Godoy Herrera','629404917');
...
INSERT INTO articulo VALUES('A-0'||TO_CHAR(articulos.nextval),'Local','DE-01',50,50,'Montaje ordenador',99999,'Montaje');
INSERT INTO articulo VALUES('A-0'||TO_CHAR(articulos.nextval),'Local','DE-02',30,30,'Reparación odenador',99999,'Reparación');
INSERT INTO articulo VALUES('A-0'||TO_CHAR(articulos.nextval),'Local','DE-02',30,30,'Limpiar virus',99999,'Limpiar');
INSERT INTO articulo VALUES('A-0'||TO_CHAR(articulos.nextval),'Local','DE-01',30,30,'Cambiar pieza',99999,'Cambiar');
INSERT INTO articulo VALUES('A-0'||TO_CHAR(articulos.nextval),'C-020','DE-05',0.40,0.70,'Bolígrago',1000,'Bolígrafos');
