...
--Inserción que debe de devolver una cadena diciendo que no hay suficientes artículos.
    INSERT INTO pedido VALUES('E-000000'||TO_CHAR(pedidos.nextval),'58340212S','A-020','DE-04',2,'23/4/2021',null,(SELECT calcula_precio('A-006',2) from dual));
END;
/
